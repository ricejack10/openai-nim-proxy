...
// Confirmed live in NVIDIA API docs as of March 2026
const MODEL_MAPPING = {
  'gpt-4':           'qwen/qwen3.5-397b-a17b',               // replaces retired qwen3-235b-a22b
  'gpt-3.5-turbo':   'nvidia/llama-3.3-nemotron-super-49b-v1', // replaces retired nemotron-ultra-253b
  'claude-3-opus':   'qwen/qwen3.5-397b-a17b',               // alias for gpt-4
  'claude-3-sonnet': 'nvidia/llama-3.3-nemotron-super-49b-v1', // alias for gpt-3.5-turbo
  'gpt-4-turbo':     'deepseek-ai/deepseek-r1-distill-qwen-14b', // native thinker, stripped
  'claude-3-haiku':  'deepseek-ai/deepseek-r1-distill-llama-8b', // native thinker, stripped — CONFIRMED WORKING
  'gemini-pro':      'deepseek-ai/deepseek-r1-distill-qwen-7b',  // smaller/faster R1 distill
  'gpt-4o':          'deepseek-ai/deepseek-v3_2',            // fixed: underscore not dot
  'gpt-4o-mini':     'meta/llama-3.3-70b-instruct',          // lightweight fallback
};
